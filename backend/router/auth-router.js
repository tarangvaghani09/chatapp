...
router.route("/admin-dashboard").get(verifyToken,isAdmin,chatcontrollers.adminDashboard);

router.route("/allUsers").get(verifyToken,isAdmin,chatcontrollers.allUsers);

router.route("/deleteUser/:id").delete(verifyToken,isAdmin,chatcontrollers.deleteUser);

router.route('/userActivity/:id').get(verifyToken, isAdmin, chatcontrollers.getUserActivity);
